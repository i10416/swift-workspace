...
open class QueryParser: Parser {
    ...
    open func factor() throws -> FactorContext {
        ...
        do {
            setState(35)
            try _errHandler.sync(self)
            switch try QueryParser.Tokens(rawValue: _input.LA(1))! {
    ...
    private func expr_sempred(_: ExprContext!, _ predIndex: Int) throws -> Bool {
        switch predIndex {
    ...
    private func term_sempred(_: TermContext!, _ predIndex: Int) throws -> Bool {
        switch predIndex {
