...
open class QueryVisitor<T>: ParseTreeVisitor<T> {
    /**
      ...
      */
    open func visitExpr(_: QueryParser.ExprContext) -> T {
    ...
    /**
     ...
     - returns: the visitor result
      */
    open func visitTerm(_: QueryParser.TermContext) -> T {
        fatalError(#function + " must be overridden")
    }
    ...
    /**
     ...
     - returns: the visitor result
      */
    open func visitFactor(_: QueryParser.FactorContext) -> T {
        fatalError(#function + " must be overridden")
    }
    ...
    /**
     ...
     - returns: the visitor result
      */
    open func visitKeywords(_: QueryParser.KeywordsContext) -> T {
        fatalError(#function + " must be overridden")
    }
    ...
    /**
     ...
     - returns: the visitor result
      */
    open func visitKeyword(_: QueryParser.KeywordContext) -> T {
        fatalError(#function + " must be overridden")
    }
}
